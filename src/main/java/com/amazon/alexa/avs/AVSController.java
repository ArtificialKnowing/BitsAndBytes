...
public class AVSController implements RecordingStateListener, AlertHandler, AlertEventListener,
    ...
    // Bits and Bytes
    private boolean emotionAnalyticsEnabled = false;
    ...
    // Bits and Bytes
    public void setEmotionAnalytics(boolean onOff) {
        emotionAnalyticsEnabled = onOff;
    }
   
    public boolean isEmotionAnalyticsEnabled() {
        return emotionAnalyticsEnabled;
    }
}
